...
class ABEmain2(wx.Panel):
    def __init__(self, parent, log, pos=wx.DefaultPosition, size=wx.DefaultSize):
        ...
        dock_offset = 0
        self.cancelButton = wx.BitmapButton(self.dock,bitmap=wx.Bitmap(cancelImage),pos=(10,dock_offset+15))#240
        self.cancelButton.Bind(wx.EVT_BUTTON,self.onCancelButtonClicked)
        self.cancelLabel = wx.StaticText(self.dock,label="Cancel",pos=(10,dock_offset),style=wx.ALIGN_CENTRE)
        ...
        self.encryptButton = wx.BitmapButton(self.dock,bitmap=wx.Bitmap(encryptImage),pos=(560,dock_offset+15))
        ...
        self.encryptLabel = wx.StaticText(self.dock,label="Encrypt",pos=(555,dock_offset),style=wx.ALIGN_CENTRE)
